...
const handleSubmit = (e) => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <input type='text' placeholder='Year .eg(2023)' value={year} onChange={(e)=> setYear(e.target.value)} />

            <input type='text' placeholder='Language' value={languageFilter} onChange={(e)=> setLanguageFilter(e.target.value)} />
