...
export default function RecordList() {
    ...
    //this method fetches the record from the database
    useEffect(() => {
            ...
            <div className="relative w-full overflow-auto">
                <table className="w-full caption-bottom text-sm">
                    <thead className="[&amp; _tr]:border-b" >
                        ...
                        50 data-[state=selected]:bg-muted">
                            <th className="h-12 px-4 text-left align-middle
                             font-medium text-muted-foreground 
                             [gamp;:has ([role=checkbox])] :pr-0">
                                Name
                            </ th>
                            <th className="h-12 px-4 text-left align-middle 
                            font-medium text-muted-foreground [samp; :has
                             ([role=checkbox])]:pr-0">
                                Position
                            </ th>
                            <th className="h-12 px-4 text-left align-middle
                            font-medium text-muted-foreground [gamp; :has 
                            ([role=checkbox])]:pr-0">
                                Level
                            < th>
                            <th className="h-12 px-4 text-left align-middle 
